...
%% ── \subanim test — growing line then persistent state ─────────────────────
%%
%% Outer step 1 (0–0.3 s): line grows A→B in 5 inner sub-steps of 0.06 s each.
%% Outer step 2 (0.3–0.6 s): full line persists (separate \reveal[step=2]).
%%
\begin{tikzpicture}
  \begin{animate}[duration=0.3, loop=false]
    ...
    \animstep
    %% outer step 2 — empty; persistent line shown via \reveal[step=2] above
  \end{animate}
\end{tikzpicture}
