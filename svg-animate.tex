...
\begin{docKey}[anim]{blink}{=\meta{seconds}}{no default}
  ...
  between \docValue{active opacity} and \docValue{inactive opacity} at the
  given period.  The element behaves normally (fully hidden or dimmed) during
  all other steps.
  ...
  When both are specified, \texttt{blink} wins and \texttt{step} is ignored.
