...
\end{dispListing}
  ...
  By default, \cs{subanim} uses the time window of the outer step in
  which it appears in the source.  Pass \texttt{step=\meta{A}-\meta{B}} in
  \oarg{options} to make the group span the combined window of outer steps
  \meta{A} through~\meta{B}:
